...
import com.jeje.newarchitecture.MainApplicationReactNativeHost;
import java.lang.reflect.InvocationTargetException;
import java.util.List;
// jsi config
import java.util.Arrays; // jsi
import com.facebook.react.bridge.JSIModuleSpec; // jsi
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.jeje.ReactNativeFlipper");
        aClass
